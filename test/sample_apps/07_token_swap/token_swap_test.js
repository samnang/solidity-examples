...
describe("Sample Apps / Token Swap", function () {
  ...
  beforeEach(async () => {
    ...
    const ABCContract = await ethers.getContractFactory("contracts/sample_apps/07_token_swap/MyTokenBob.sol:MyTokenBob", signer1);
    const XYZContract = await ethers.getContractFactory("contracts/sample_apps/07_token_swap/MyTokenBob.sol:MyTokenBob", signer2);
    ...
    const Contract = await ethers.getContractFactory("contracts/sample_apps/07_token_swap/TokenSwap.sol:TokenSwap", owner);
