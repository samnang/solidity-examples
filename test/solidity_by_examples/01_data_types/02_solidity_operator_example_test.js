...
describe("Data Types / SolidityOperatorExample", function () {
  let contract;

  beforeEach(async () => {
    const Contract = await ethers.getContractFactory("contracts/solidity_by_examples/01_data_types/02_SolidityOperatorExample.sol:SolidityOperatorExample");
